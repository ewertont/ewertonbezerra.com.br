  ...
  return (
    <section id="about" style={{ padding: "100px 4rem", background: "var(--bg2)" }}>
      <div className="max-w-5xl mx-auto">
        ...
        <h2 className="reveal text-4xl md:text-5xl font-semibold tracking-tight mb-16" style={{ letterSpacing: "-0.03em" }}>
          Who I Am
        </h2>
        ...
        <div className="grid md:grid-cols-2 gap-20 items-start">
          ...
          <div className="hidden md:flex justify-center relative">
            ...
            <div
              ...
              style={{
                background: "linear-gradient(135deg, #1e3a7a 0%, #3b1f6e 100%)",
          ...
          <div>
            {about.bio.map((p, i) => (
              <p key={i} className="reveal text-base leading-relaxed mb-6 font-light" style={{ color: "#8da0c4" }}>
                {p}
              </p>
            ))}
            ...
            <div className="flex flex-col gap-3 mt-8">
              {about.highlights.map((h, i) => (
                ...
                >
                  ...
                  <div>
                    <strong className="block text-sm font-medium mb-0.5" style={{ color: "#e8edf8" }}>
                      {h.title}
                    </strong>
                    <span className="text-sm" style={{ color: "#8da0c4" }}>
                      {h.description}
                    </span>
                  </div>
                </div>
