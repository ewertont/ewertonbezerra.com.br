...
export default function Footer() {
  ...
  const socials = [
    ...
    { href: `mailto:${siteConfig.email}`, label: "Email", icon: <span className="text-sm">✉</span> },
  ].filter((s) => s.href && s.href !== "" && !s.href.endsWith("//"));
      ...
      <div className="flex gap-3">
        {socials.map((s) => (
          <a
            ...
            title={s.label}
            className="social-link w-9 h-9 flex items-center justify-center rounded-lg no-underline"
            style={{
